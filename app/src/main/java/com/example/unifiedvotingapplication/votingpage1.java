...
public class votingpage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_votingpage1);

        final String title = getIntent().getStringExtra("election");
        final String user = getIntent().getStringExtra("user");

        GridLayoutManager gridLayoutManager = new GridLayoutManager(votingpage1.this,1);
        recyclerView = findViewById(R.id.vrec);
        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));


        AlertDialog.Builder builder = new AlertDialog.Builder(votingpage1.this);
        ...
        cardAdapter = new CardAdapter1(votingpage1.this, cardList,user);
