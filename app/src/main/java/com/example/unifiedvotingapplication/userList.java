...
public class userList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(userList.this,1);
        ...
        adapter = new MyAdapter1(userList.this, dataList);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(userList.this, upload.class);
    ...
    public void searchList(String text){
        ArrayList<DataClass1> searchList = new ArrayList<>();
        for (DataClass1 dataClass: dataList){
